    ...
    context "on #{os}" do
      ...
      describe 'with default values for all parameters' do
        ...
        when '6'
          ...
          it {
            is_expected.to contain_service('ktune').with(
            enable: true,
            ensure: 'running',
          )
          }
        ...
        it {
          is_expected.to contain_package('tuned').with(
          ensure: 'present',
        )
        }
      ...
      describe 'with active_profile => virtual-guest' do
        ...
        it {
          is_expected.to contain_class('tuned::profile::enable_profile').with(
        ...
        when '6'
          it {
            is_expected.to contain_exec("tuned-adm_enable_profile_#{params[:active_profile]}").with(
